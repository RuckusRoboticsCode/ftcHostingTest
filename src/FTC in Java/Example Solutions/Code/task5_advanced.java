...
public class task5_advanced extends LinearOpMode {
    DcMotorEx FL;
    DcMotorEx FR;
    DcMotorEx BL;
    DcMotorEx BR;
    ...
    /**
     * Drive straight the specified distance
     * Positive is forward
    ...
    /**
     * Strafe the specified distance
     * Positive distance is left, negative distance is right
     * @param inches  The distance to strafe
     */
